...
```
General rules for choosing the correct number of bins exists. We recommend that you experiment with different number of bins to find the one you like best.
