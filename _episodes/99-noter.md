...
~~~
Error in ggplot(data = surveys_complete, aes(x = weight, y = hindfoot_length)): object 'surveys_complete' not found
~~~
{: .error}
...
~~~
Error in count(., year, genus): object 'surveys_complete' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = yearly_counts, aes(x = year, y = n)): object 'yearly_counts' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = yearly_counts, aes(x = year, y = n, group = genus)): object 'yearly_counts' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = yearly_counts, aes(x = year, y = n, color = genus)): object 'yearly_counts' not found
~~~
{: .error}
...
~~~
Error in ggplot(., mapping = aes(x = year, y = n, color = genus)): object 'yearly_counts' not found
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'yearly_counts_graph' not found
~~~
{: .error}
...
~~~
Error in count(., year, genus, sex): object 'surveys_complete' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex)): object 'yearly_sex_counts' not found
~~~
{: .error}
...
~~~
Error in eval(expr, envir, enclos): object 'plot_weight' not found
~~~
{: .error}
